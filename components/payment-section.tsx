...
export function PaymentSection({ formData, onSubmit, onBack }: PaymentSectionProps) {
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-slate-100">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 py-3.5 rounded-2xl font-black text-white text-sm bg-[#1268A1] hover:bg-[#0e5587] shadow-[0_4px_0_#0a3d66] active:translate-y-1 active:shadow-none transition-[transform,box-shadow] duration-75"
            >
